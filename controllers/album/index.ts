...
export const createAlbum = catchAsyncError(
...
export const getAlbum = catchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const getAllAlbum = catchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const deleteAlbum = catchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const updateAlbum = catchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
