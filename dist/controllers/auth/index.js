...
exports.updateUserRole = exports.getUser = exports.logout = exports.google = exports.login = exports.register = void 0;
...
exports.updateUserRole = (0, catchAsyncError_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    ...
    if (req.user.role === "admin") {
        ...
        const { role } = req.body;
        const admin = yield user_1.default.findOneAndUpdate(filter, { role }, { new: true });
        res.status(200).json({
