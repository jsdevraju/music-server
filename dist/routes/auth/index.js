...
router.get("/getAllUser", auth_2.isAuthenticated, auth_1.getUser);
router.put(`/promoteRole/:id`, auth_2.isAuthenticated, (0, auth_2.adminRole)("admin"), auth_1.updateUserRole);
